                        ...
                        foreach ($blogtags as $key) {
                            echo    '<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/business/deleteblogtag/'.$key->id.'" title="Удалить" class="btn btn-danger" aria-label="Удалить" data-confirm="Вы уверены, что хотите удалить этот элемент?" data-method="post" data-pjax="0">
                        ...
                        foreach ($privatewidget as $key) {
                            echo    '<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/bisness/deletepw/'.$key->id.'" title="Удалить" class="btn btn-danger" aria-label="Удалить" data-confirm="Вы уверены, что хотите удалить этот элемент?" data-method="post" data-pjax="0">
                                                <span class="glyphicon glyphicon-trash"></span>
                                            </a>
                                        </td>
                                    </tr>';
